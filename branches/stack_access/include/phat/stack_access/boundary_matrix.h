...
namespace phat {
    ...
    class stack_access_boundary_matrix : public common::read_only_boundary_matrix< Representation >
    {
    ...
    public:
        ...
        stack_access_boundary_matrix< Representation >& operator=( const common::read_only_boundary_matrix< OtherRepresentation >& other )
        {
    ...
    public:
        ...
        void load_vector_vector( const std::vector< std::vector< index_type > >& input_matrix, const std::vector< dimemsion_type >& input_dims ) { 
            ...
            for( index cur_col = 0; cur_col < nr_of_columns; cur_col++ ) {
                ...
                push_col( temp_col, (dimension)input_dims[ cur_col ] );
            }
        }
        ...
        bool load_ascii( std::string filename ) { 
            ...
            while( getline( input_stream, cur_line ) ) {
                ...
                if( cur_line != "" && cur_line[ 0 ] != '#' ) {
                    ...
                    push_col( temp_col, (dimension) temp_dim );
                }
            }
        ...
        bool load_binary( std::string filename ) { 
            ...
            for( index cur_col = 0; cur_col < nr_columns; cur_col++ ) {
                ...
                push_col( temp_col, (dimension) cur_dim );
            }
